...
import activeImg from "../../../Assests/ups 6.png";
import downloaf from "../../../Assests/8 DCP Battery.pdf"
        ...
        <div className="flex flex-col justify-between lg:flex-row gap-16 lg:items-center">
          ...
          <div className="flex flex-col gap-4 lg:w-2/4">
            <div>
              ...
              DCP 12V/7AH TO 200AH
              </span>
              <h1 className="text-6xl font-bold">  DCP Battery</h1>
