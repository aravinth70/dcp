...
import activeImg from "../../../Assests/ups-10.png";
import downloaf from "../../../Assests/2 DCP POWER ON LINE UPS 2022.pdf"
        ...
        <div className="flex flex-col justify-between lg:flex-row gap-16 lg:items-center">
          <div className="flex flex-col gap-4 lg:w-2/4">
            <img
              src={activeImg}
              alt=""
              className="w-120 pl-1 rounded-xl" // Adjust the size using Tailwind CSS classes
            />
          </div>
          {/* ABOUT */}
          <div className="flex flex-col gap-4 lg:w-2/4">
            <div>
              ...
              <h1 className="text-6xl font-bold"> DCP Power 3300 </h1>
            ...
            <div className="flex flex-row items-center gap-12 py-6">
              <a
                ...
                download="DCP POWER 3300" // This attribute triggers the download
