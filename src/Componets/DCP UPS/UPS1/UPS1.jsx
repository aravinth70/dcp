...
import activeImg from "../../../Assests/ups 3.png";
import downloaf from "../../../Assests/1  DCP LINE  INTERCATIVE 2024.pdf"
        ...
        <div className="flex flex-col justify-between lg:flex-row gap-16 lg:items-center">
          <div className="flex flex-col gap-4 lg:w-2/4">
            <img
              src={activeImg}
              alt=""
              className="w-90  rounded-xl" // Adjust the size using Tailwind CSS classes
            />
          </div>
          {/* ABOUT */}
          <div className="flex flex-col gap-4 lg:w-2/4">
            <div>
              ...
              650VA/850VA/1200VA/2000VA/3000VA
              </span>
              <h1 className="text-6xl font-bold">DCP Version 2.0</h1>
