        ...
        <div className="grid grid-cols-2 gap-2 border-t-4 border-slate-300">
          ...
          <p className=" text-black m-0  pt-6 px-5 text-[20px]">
            ...
            <p className=" text-black m-0   px-5 text-[20px]">
              <span className="font-semibold">40 KVA to 80 KVA :</span>780 x 425 x 1200
            </p>
            <p className=" text-black m-0   px-5 text-[20px]">
              <span className="font-semibold">100 KVA to 120 KVA :</span>960 x 600 x 1600
            </p>
            <p className=" text-black m-0   px-5 text-[20px]">
              <span className="font-semibold">160 KVA :</span>960 x 600 x 1000
            </p>
            <p className=" text-black m-0  pb-6 px-5 text-[20px]">
              <span className="font-semibold">200 KVA:</span>1010 x 600 x 200
            </p>
          </div>
        </div>
